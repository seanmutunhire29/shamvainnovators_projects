...
if "christine_materials" not in st.session_state:
    st.session_state.christine_materials = [
...
if menu == "Search materials":
    ...
    if st.button("Search"):
        if search == "":
            ...
            results = [m for m in st.session_state.christine_materials
...
if search:
    for note in st.session_state.christine_materials:
